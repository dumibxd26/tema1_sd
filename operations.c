...
ds_list *merge_lists(ds_list *first_list, ds_list *second_list)
{
    ds_list *merged = create_list();

    ds_node *aux1 = first_list->head;
    ds_node *aux2 = second_list->head;
    ...
    {
        ds_card_data *data1 = (ds_card_data *)aux1->data;
        ds_node *node = create_node(create_card(data1->sym_conversion,
                                                data1->val));
        add_to_list(merged, node);
        aux1 = aux1->next;
    }
    ...
    {
        ds_card_data *data2 = (ds_card_data *)aux2->data;
        ds_node *node = create_node(create_card(data2->sym_conversion,
                                                data2->val));
        add_to_list(merged, node);
        aux2 = aux2->next;
    }
